...
function App() {
  ...
  //stores keys of first object in array
 useEffect(()=>{
 ...
 const deleteHandler=(id)=>{
  const deletedProd=users.filter((eachUser)=>{
    return eachUser.id!==id;
  })
  setUsers(deletedProd);
  console.log('item deleted ');
 }
  return (
    <>
    <TableComp header={header} users={users} deleteHandler={deleteHandler}/>
    </>
  )
}
